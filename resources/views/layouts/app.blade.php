...
<html lang="en">
  <head>
    ...
    <title>Laravel + TailwindCss Dashboard</title>
    <link
    ...
    <script src="{{asset('build/js/component.min.js')}}"></script>
    <script src="{{asset('build/js/alpine.min.js')}}" defer></script>
  </head>
  <body>
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="{{ asset('build/images/avatar.jpg')}}" alt="Francis Gill" />
                  </button>
              ...
              <div class="space-y-4" x-show.transition.in="activeTabe == 'user'">
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Francis Gill</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                  ...
                  <div class="flex px-4 space-x-4">
                    <div class="relative flex-shrink-0">
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        <img
                          class="object-cover rounded-full w-9 h-9"
                          src="{{ asset('build/images/avatar-1.jpg') }}"
                          alt="Francis Gill"
                        />
                      </span>
                      <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
          ...
          <div class="flex flex-col h-screen">
            ...
            <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="{{ asset('build/images/cover.jpg') }}" alt="Post cover" />
                </div>
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="{{ asset('build/images/avatar.jpg') }}" alt="Francis Gill" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
                  <h4 class="text-sm font-semibold text-gray-600 dark:text-light">Francis Gill</h4>
                  <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg"  src="{{ asset('build/images/cover-2.jpg') }}" alt="K-WD Dashboard" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
              ...
              <template x-for="i in 10" x-key="i">
                <a href="#" class="flex space-x-4">
                  <div class="flex-shrink-0">
                    <img class="w-10 h-10 rounded-lg" src="{{ asset('build/images/cover-3.jpg') }}" alt="K-WD Dashboard" />
                  </div>
                  <div class="flex-1 max-w-xs overflow-hidden">
                    <h4 class="text-sm font-semibold text-gray-600 dark:text-light">K-WD Dashboard</h4>
                    <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
    ...
    <script src="{{ asset('build/js/Chart.bundle.min.js') }}"></script>
